...
<div class="tutorial">
    <button class="btn-inicio">
      <a href="index.php">
        <strong><?php if($paginaActual == 'index.php') echo '• '; ?>Inicio</strong>
      </a>
    </button>
    <button class="btn-servicio">
      <a href="ServicioAlCliente.php">
        <strong><?php if($paginaActual == 'ServicioAlCliente.php') echo '• '; ?>Servicio al cliente</strong>
      </a>
    </button>
    <button class="btn-nosotros">
      <a href="sobrenosotros.php">
        <strong><?php if($paginaActual == 'sobrenosotros.php') echo '• '; ?>Sobre nosotros</strong>
      </a>
    </button>
